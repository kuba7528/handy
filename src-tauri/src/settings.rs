...
pub struct AppSettings {
    ...
    /// When enabled, Handy keeps listening continuously and transcribes each
    /// detected utterance automatically, without requiring a shortcut. Runs
    /// until the app is closed or the feature is disabled.
    #[serde(default = "default_continuous_listening")]
    ...
    #[serde(default)]
    pub append_trailing_period: bool,
...
pub fn get_default_settings() -> AppSettings {
    ...
    AppSettings {
        ...
        continuous_listening: default_continuous_listening(),
